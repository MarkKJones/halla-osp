\infolevone{\chapter[Compton Polarimeter]{Compton Polarimeter \footnote{Author: D.~Gaskell \email{gaskelld@jlab.org}}}
\label{sec:compton}
...
using  Compton scattering of polarized electrons from polarized photons. \infolevone{A schematic layout of the
...
\bibitem{compton_LSOP} Jeffeson Lab Laser Standard Operating Procedure for Hall A Compton Polarimeter Laser System,\url{https://mis.jlab.org/mis/apps/mis_forms/operational_safety_procedure_form.cfm?entry_id=138973}.
